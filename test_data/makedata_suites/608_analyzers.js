    ...
    checkDataDB: function (options, isCluster, isEnterprise, database, dbCount, readOnly) {
      ...
      function checkProperties(analyzer_name, obj1, obj2) {
        ...
        if (obj1Length === obj2Length) {
          ...
          throw new Error(`608: ${analyzer_name} analyzer's type missmatched!`);
        }
      };
      ...
      function checkAnalyzer(analyzerName, expectedType, expectedProperties, expectedResult, queryResult){
        ...
        if (testName !== expectedName) {
          throw new Error(`608: ${analyzerName} analyzer not found`);
        }
        progress();
        ...
        if (testType !== expectedType){
          throw new Error(`608: ${analyzerName} analyzer type missmatched!`);
        }
        progress();
