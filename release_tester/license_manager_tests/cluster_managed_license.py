...
class ManagedLicenseClusterTestSuite(LicenseManagerClusterBaseTestSuite, ManagedLicenseBaseTestSuite):
    ...
    @testcase("1. Generate a license key with operator platform tool and apply the license - Cluster")
    ...
    @testcase("2. Use operator platform tool to activate deployment - Cluster")
