...
class ServicePage(NavigationBarPage):
    ...
    def select_service_page(self):
        ...
        service_sitem = self.locator_finder_by_id(self, service)
        service_sitem.click()
        time.sleep(2)
    ...
    def select_add_service_button(self):
        ...
        add_new_service_stiem = self.locator_finder_by_id(self, add_new_service)
    ...
    def service_search_option(self, search_keyword):
        ...
        search = 'foxxSearch'
        service_search_stiem = self.locator_finder_by_id(self, search)
        ...
        if search_keyword == 'demo':
            ...
            demo_graphql_stiem = self.locator_finder_by_xpath(self, search_item)
    ...
    def service_category_option(self):
        ...
        select_service_category_sitem = self.locator_finder_by_id(self, category)
    ...
    def service_filter_category_option(self):
        ...
        filter_option_stiem = self.locator_finder_by_xpath(self, filter_option)
    ...
    def select_category_option_from_list(self, category):
        ...
        if category == 'connector':
            ...
            connector_stiem = self.locator_finder_by_xpath(self, connector_name)
    ...
    def select_category_option_search_filter(self, keyword):
        ...
        filter_placeholder_sitem = self.locator_finder_by_id(self, filter_placeholder)
        ...
        if keyword == 'geo':
            ...
            search_category_sitem = self.locator_finder_by_xpath(self, search_category)
            expected_text = 'geo'
    ...
    def select_demo_geo_s2_service(self):
        ...
        geo_service_sitem = self.locator_finder_by_xpath(self, geo_service)
    ...
    def setup_demo_geo_s2_service(self):
        ...
        github_link_sitem = self.locator_finder_by_xpath(self, github_link)
    ...
    def install_demo_geo_s2_service(self, mount_path, test_data_dir):
        ...
        mount_point_sitem = self.locator_finder_by_id(self, mount_point)
        ...
        install_btn_sitem = self.locator_finder_by_id(self, install_btn)
        ...
        try:
            success_sitem = self.locator_finder_by_xpath(self, success).text
            ...
            if status:
                ...
                self.locator_finder_by_id(self, collection_page).click()

                # looking for default collection has been created or not
                neighbourhood_collection = '//*[@id="collection_neighborhoods"]/div/h5'
                neighbourhoods_collection_sitem = self.locator_finder_by_xpath(self, neighbourhood_collection)
                ...
                if neighbourhoods_collection_sitem.text == 'neighborhoods':
                    ...
                    self.locator_finder_by_xpath(self, upload).click()
                    time.sleep(1)
                    ...
                    choose_file_btn_sitem = self.locator_finder_by_id(self, choose_file_btn)
                    choose_file_btn_sitem.send_keys(str(path1.absolute()))
                    time.sleep(1)

                    print('Pressing on confirm btn \n')
                    confirm_btn = 'confirmDocImport'
                    self.locator_finder_by_id(self, confirm_btn).click()
                    time.sleep(1)
                ...
                restaurants_collection_sitem = self.locator_finder_by_xpath(self, restaurants_collection)
                time.sleep(1)
                ...
                if restaurants_collection_sitem.text == 'restaurants':
                    ...
                    self.locator_finder_by_xpath(self, select_service).click()
                    time.sleep(1)

                    print('inspecting demo_geo_s2 service interface \n')
                    geo_service = '//*[@id="information"]/div/div[2]/div[2]/input'
                    self.locator_finder_by_xpath(self, geo_service).click()
                    time.sleep(4)
                    ...
                    self.locator_finder_by_id(self, random_restaurant).click()
                    time.sleep(3)

                    print('Visualize random Neighborhood \n')
                    random_neighborhood = 'randomNeighborhood'
                    self.locator_finder_by_id(self, random_neighborhood).click()
                    time.sleep(3)

                    print('Visualize Distance \n')
                    distance = 'geoDistance'
                    self.locator_finder_by_id(self, distance).click()
                    time.sleep(3)

                    print('Visualize Distance between \n')
                    distance_between = 'geoDistanceBetween'
                    self.locator_finder_by_id(self, distance_between).click()
                    time.sleep(3)

                    print('Visualize Geo distance nearest \n')
                    distance_nearest = 'geoDistanceNearest'
                    self.locator_finder_by_id(self, distance_nearest).click()
                    time.sleep(3)

                    print('Visualize Geo intersection \n')
                    intersection = 'geoIntersection'
                    self.locator_finder_by_id(self, intersection).click()
                    time.sleep(3)
    ...
    def check_demo_geo_s2_service_api(self):
        ...
        api = 'service-api'
        self.locator_finder_by_id(self, api).click()
        time.sleep(2)

        print("Changing view to JSON form \n")
        json = 'jsonLink'
        self.locator_finder_by_id(self, json).click()
        time.sleep(3)
    ...
    def checking_function_for_fox_leaflet(self, id_list):
        ...
        while i < len(id_list):
            ...
            self.locator_finder_by_xpath(self, id_list[i]).click()
            time.sleep(2)
            self.locator_finder_by_xpath(self, id_list[i]).click()
    ...
    def inspect_foxx_leaflet_iframe(self):
        ...
        self.driver.switch_to.frame(self.locator_finder_by_id(self, iframe_id))
        time.sleep(1)

        print("Checking default view \n")
        default_view = "operations-tag-default"
        self.locator_finder_by_id(self, default_view).click()
        time.sleep(2)
        self.locator_finder_by_id(self, default_view).click()
    ...
    def select_service_settings(self):
        ...
        self.locator_finder_by_id(self, settings).click()
    ...
    def delete_service(self, service_name):
        ...
        if service_name == 'demo_geo_s2':
            ...
            try:
                ...
                service_sitem = self.locator_finder_by_xpath(self, service).text
                time.sleep(1)

                if service_sitem == 'demo-geo-s2':
                    print(f'{service_sitem} service has been found and ready to delete \n')
                    self.locator_finder_by_xpath(self, service).click()
                    time.sleep(1)
                    ...
                    self.locator_finder_by_xpath(self, delete_service).click()
                    time.sleep(1)

                    confirm_delete = 'modalButton1'
                    self.locator_finder_by_id(self, confirm_delete).click()
                    time.sleep(1)

                    pressing_yes = 'modal-confirm-delete'
                    self.locator_finder_by_id(self, pressing_yes).click()
                    time.sleep(1)
