...
from selenium_ui_test.test_suites.cluster.after_install_test_suite import \
    ClusterAfterInstallTestSuite
from selenium_ui_test.test_suites.cluster.wait_for_upgrade_test_suite import \
    ClusterWaitForUpgradeTestSuite
