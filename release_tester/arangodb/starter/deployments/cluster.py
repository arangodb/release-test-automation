...
""", "create test collection")
    ...
    def upgrade_arangod_version_impl(self):
        ...
        if self.cfg.stress_upgrade:
            benchInstances.append(self.starter_instances[0].launch_arangobench('cluster_upgrade_scenario_1'))
            benchInstances.append(self.starter_instances[1].launch_arangobench('cluster_upgrade_scenario_2'))
        for node in self.starter_instances:
        ...
        if self.cfg.stress_upgrade:
            benchInstances[0].wait()
            benchInstances[1].wait()
