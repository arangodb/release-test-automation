...
from test_suites_core.base_test_suite import testcase, run_after_each_testcase
...
class BinaryComplianceTestSuite(CliStartedTestSuite):
    """ check the binaries and their version output """
    ...
    def test_license_info_server_package(self):
        ...
        for binary in binaries:
            with step(f"check {binary.name}"):
                binary.check_license_info()
    ...
    def test_license_info_client_package(self):
        """ check the lincense via the client package """
