        ...
        for enterprise, encryption_at_rest, directory_suffix, testrun_name in execution_plan:
            ...
            with AllureTestSuiteContext(alluredir,
                ...
                if old_dlstage[j] != "local":
                    dl_old = AcquirePackages(old_version[j], verbose, package_dir, enterprise,
                                             enterprise_magic, zip_package, old_dlstage[j],
                ...
                if new_dlstage[j] != "local":
                    dl_new = AcquirePackages(new_version[j], verbose, package_dir, enterprise,
                                             enterprise_magic, zip_package, new_dlstage[j],
                                             httpusername, httppassvoid, remote_host)
...
@common_options(support_multi_version=True, support_old=True, interactive=False, test_data_dir='/home/test_dir')
...
""".format(
    len_old_version= len(old_version), old_version= str(old_version),
